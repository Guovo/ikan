<?php
/*
如需代写整合播放器接口文件。20元加qq3119564676如果不在线请留言
支持手机电脑播放。电脑默认高清的。手机的只有一个清晰度。具体请自行测试
演示地址 http://biguwu.com/jx.php?url=CNTU4MTI1Ng==
爱奇艺优酷vip视频解析接口免费分享。加QQ群  29693589
看群公告。本群以分享c值资源和免费解析为目的存在。
每天更新c值资源免费接口。还有百度直链系统都免费分享
更多解析请加QQ群  29693589
*/
error_reporting(0);
